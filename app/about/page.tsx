  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main>
        ...
        <section className="our-story py-16">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">How we became the leading sports equipment provider</p>
            </div>
        ...
        <section className="our-values py-16 bg-gray-50">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">The principles that guide our business</p>
            </div>
        ...
        <section className="team py-16">
          <div className="container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground">The people behind AKAZ Sports Hub</p>
            </div>
        ...
        <section className="newsletter py-16 bg-gray-50">
          <div className="container">
            <h2 className="text-3xl font-bold mb-4 text-center">Join Our Community</h2>
            <p className="text-xl mb-8 max-w-2xl mx-auto text-center text-muted-foreground">
            ...
            <form className="newsletter-form flex max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-l-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#f58549]"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-gradient-to-r from-[#f58549] to-[#eda24e] text-white rounded-r-lg hover:opacity-90 transition-opacity"
              >
                Subscribe
              </button>
            </form>
